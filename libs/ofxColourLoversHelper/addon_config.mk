...
meta:
	ADDON_NAME = ofxColourLoversHelper
	ADDON_DESCRIPTION = openFrameworks helper addon to handle ColourLovers palettes using the core addon ofxColourLovers from @borg
	ADDON_AUTHOR = @moebiussurfing
	ADDON_TAGS = "addon" "template"
	ADDON_URL = http://github.com/moebiussurfing/ofxColourLoversHelper
