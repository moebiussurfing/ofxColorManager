...
meta:
	ADDON_NAME = ofxColorQuantizerHelper
	ADDON_DESCRIPTION = addon to get the dominant colors of a picture. Helps the integration and workflow of **ofxColorQuantizer** coded by @mantissa.
	ADDON_AUTHOR = @moebiussurfing
	ADDON_TAGS = "color" "quatizer" "dominant colors"
	ADDON_URL = http://github.com/moebiussurfing/ofxColorQuantizerHelper
