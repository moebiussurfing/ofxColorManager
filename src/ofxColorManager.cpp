...
void ofxColorManager::gui_LayoutsManager()
{
	...
	bool bMin = true;//hide load buttons to simplify
	float max = (bMin ? 150 : 200);

	ImGui::PushStyleVar(ImGuiStyleVar_WindowMinSize, ImVec2(max, PANEL_WIDGETS_HEIGHT));
