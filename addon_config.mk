...
meta:
	ADDON_NAME = ofxColorManager
	ADDON_DESCRIPTION = An openFrameworks addon as palettes manager with different algorithmic palettes, gradients and user kit handler.
	ADDON_AUTHOR = @moebiussurfing
	ADDON_TAGS = "color" "manager"
	ADDON_URL = http://github.com/moebiussurfing/ofxColorManager
